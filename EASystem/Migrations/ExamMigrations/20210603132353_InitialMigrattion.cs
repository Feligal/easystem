    ...
    public partial class InitialMigrattion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminUserProfile", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminUserProfile_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientUserProfile_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamTaken", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamTaken_ClientUserProfile_ClientUserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminUserProfile_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientUserProfile_AppUserId",
                table: "ClientUserProfile",
                column: "AppUserId",
                unique: true,
                filter: "[AppUserId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ExamTaken_ClientUserProfileId",
                table: "ExamTaken",
